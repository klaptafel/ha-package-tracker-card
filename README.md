...
- [ha-parcel-integrations/ha-dhl-nl](https://github.com/ha-parcel-integrations/ha-dhl-nl): 2.0.0 (stable) or newer recommended. 2.3.0+ adds an optional per-parcel event history (off by default, enable it in the integration's options).
- [ha-parcel-integrations/ha-dpd](https://github.com/ha-parcel-integrations/ha-dpd): 2.0.0 (stable) or newer recommended. 2.3.0+ adds an optional per-parcel event history (off by default, enable it in the integration's options).
